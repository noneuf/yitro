...
<div class="menuStyle">
    <div class="flex column menuStyle position">
        <a href="../index.php" class="noStyle"><h2 class="titleInMenuStyle">YITRO</h2></a>
        ...
        <div class="flex justifyContent specificId">
        ...
        <small class="copyStyle">&copy Nathan Goel - 2019</small>
    </div>     
</div>
